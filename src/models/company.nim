...
type
  Company* = ref object of Model
    ...
    auto_validate_on_import*: bool
      ...
      default_cash_account_id* {.fk: Account.}: Option[int64]
      default_customers_account_id* {.fk: Account.}: Option[int64]
      default_suppliers_account_id* {.fk: Account.}: Option[int64]
      default_sales_revenue_account_id* {.fk: Account.}: Option[int64]
      default_vat_purchase_account_id* {.fk: Account.}: Option[int64]
      default_vat_sales_account_id* {.fk: Account.}: Option[int64]
      default_card_payment_purchase_account_id* {.fk: Account.}: Option[int64]
      default_card_payment_sales_account_id* {.fk: Account.}: Option[int64]
    ...
    proc newCompany*(
      ...
      default_sales_revenue_account_id: Option[int64] = none(int64),
        ...
        salt_edge_app_id: string = "",
        salt_edge_enabled: bool = false    ): Company =
      Company(
        name: name,
        eik: eik,
